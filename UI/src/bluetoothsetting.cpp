...
BluetoothSetting::BluetoothSetting(QObject *parent) : QObject(parent)
{
    m_Control = nullptr;
    m_Service = nullptr;
...
void BluetoothSetting::startScan()
{
    m_devices.clear();
...
void BluetoothSetting::startConnect(QString addr)
{
    disconnectBle();
...
void BluetoothSetting::disconnectBle()
{
    if (m_Service)
    {
...
void BluetoothSetting::clearDeviceList()
{
    m_devices.clear();
    emit devicesUpdated();
}

bool BluetoothSetting::isConnected()
{
    return m_Control != nullptr && m_ConnectDone;
}

bool BluetoothSetting::isConnecting()
{
    return m_Control && !m_ConnectDone;
}

void BluetoothSetting::writeData(QByteArray data)
{
    if (isConnected())
    {
...
void BluetoothSetting::writeData(QString strData)
{
    if (isConnected())
    {
        const QLowEnergyCharacteristic  rxChar = m_Service->characteristic(QBluetoothUuid(QUuid(m_RxUuid)));
...
void BluetoothSetting::addDevice(const QBluetoothDeviceInfo &dev)
{
...
QVariant BluetoothSetting::getDevices()
{
    return QVariant::fromValue(m_devices);
}

QString BluetoothSetting::getUpdate()
{
    return m_messageStatus;
}

void BluetoothSetting::setUpdate(QString message)
{
    m_messageStatus = message;
    emit updateChanged();
}

void BluetoothSetting::scanFinished()
{
    emit devicesUpdated();
...
void BluetoothSetting::deviceScanError(QBluetoothDeviceDiscoveryAgent::Error e)
{
...
void BluetoothSetting::serviceDiscovered(const QBluetoothUuid &gatt)
{
...
void BluetoothSetting::serviceScanDone()
{
    if (m_Service)
    {
        m_Service->deleteLater();
...
void BluetoothSetting::controllerError(QLowEnergyController::Error e)
{
...
void BluetoothSetting::deviceConnected()
{
    qDebug() << "BLE device connected";
    m_Control->discoverServices();
}

void BluetoothSetting::deviceDisconnected()
{
...
void BluetoothSetting::serviceStateChanged(QLowEnergyService::ServiceState s)
{
...
void BluetoothSetting::updateData(const QLowEnergyCharacteristic &c, const QByteArray &value)
{
...
void BluetoothSetting::confirmedDescriptorWrite(const QLowEnergyDescriptor &d, const QByteArray &value)
{
...
void BluetoothSetting::connectionUpdated(const QLowEnergyConnectionParameters &newParameters)
{
    (void)newParameters;
