#include "radarpainter.h"
#include <QTimer>
#include <QPainter>
#include <QtMath>

RadarPainter::RadarPainter(QQuickItem *parent) : QQuickPaintedItem (parent)
{
...
RadarPainter::~RadarPainter()
{

}


void RadarPainter::start()
{
    m_drawable = true;
    m_angle = 0;
    m_updateTimer->start();
...
void RadarPainter::paint(QPainter *painter)
{
